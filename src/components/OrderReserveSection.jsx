        ...
        <div className="max-w-md mx-auto bg-primary-light p-8 rounded-xl border border-accent/20 text-center shadow-2xl animate-fade-in">
            ...
            <div className="flex flex-col gap-3">
                <button
                    ...
                    className={`w-full ${hasPaid ? 'bg-green-600 hover:bg-green-700 shadow-[0_0_15px_rgba(34,197,94,0.2)]' : 'bg-gray-600 cursor-not-allowed opacity-50'} text-white py-3 rounded-lg font-bold transition-all flex items-center justify-center gap-2`}
                >
                    ...
                    Confirm Order & Send to Cafe Owner
                </button>
                <button
                    onClick={() => setStep(2)}
